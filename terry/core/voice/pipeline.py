...
from terry.core.ui.terminal_led import TerminalLED, LEDState
from terry.core.voice.conversation import ConversationManager, ConversationState
import time
...
class VoicePipeline:
    ...
    async def initialize_suggestions(self):
        ...
        try:
            from terry.core.config.settings import settings
            from terry.core.memory.intelligent_suggestions import get_intelligent_suggestions
    ...
    async def initialize_barge_in(self):
        ...
        try:
            from terry.core.config.settings import settings
            from terry.features.ux.barge_in import get_barge_in

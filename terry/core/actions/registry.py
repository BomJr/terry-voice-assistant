...
from terry.core.actions.base import ActionBase, ActionCategory, ActionMetadata
...
class ActionRegistry:
    ...
    def _load_builtin_actions(self) -> None:
        ...
        try:
            from terry.core.actions.system.open_app import OpenAppAction
            from terry.core.actions.system.volume_control import (
                VolumeSetAction, VolumeUpAction,
                VolumeDownAction, VolumeMuteAction
            )
            from terry.core.actions.browser.browser_control import (
                BrowserOpenUrlAction, BrowserSearchAction,
                BrowserNewTabAction, BrowserCloseTabAction
            )
            from terry.core.actions.media.media_control import (
                MediaPlayAction, MediaPauseAction, MediaPlayPauseAction,
                MediaNextAction, MediaPreviousAction, YouTubeSkipAdAction
            )
            from terry.core.actions.terminal.command_runner import TerminalRunAction
            from terry.core.actions.utilities.timer_manager import (
                TimerSetAction, AlarmSetAction, ReminderSetAction
            )
            from terry.core.actions.utilities.conversation import NoAction
            from terry.core.actions.system.silent_mode_action import SilentModeAction  # v6.1
            from terry.core.actions.system.undo_action import UndoAction  # v6.1
            from terry.core.actions.productivity.voice_notes_action import VoiceNotesAction  # v6.1
            from terry.core.actions.vision.camera_action import CameraAction  # v6.1
            from terry.core.actions.vision.ocr_action import OCRAction  # v6.1
            from terry.core.actions.automation.scheduler_action import SchedulerAction  # v6.1
            from terry.core.actions.automation.triggers_action import TriggersAction  # v6.1
            from terry.core.actions.automation.macros_action import MacrosAction  # v6.1
            from terry.core.actions.productivity.dictation_action import DictationAction  # v6.1
            from terry.core.actions.productivity.file_search_action import FileSearchAction  # v6.1
            from terry.core.actions.productivity.ide_control_action import IDEControlAction  # v6.1
            ...
            actions_to_register = [
                ...
                CameraAction,  # v6.1 - Camera vision
